...
Talk("哦 沒事就好...............韋兄弟....你怎么了？", 0, 1);
Talk("....師父......傷得很重。暈了過去。由那位和你穿著一樣的少俠護送出宮了。", 196, 0);
Talk("北辰大哥..你說一定要反清嗎？是漢人還是滿人當皇帝這有什么關系。只要是個好皇帝不就行了嗎？", 85, 0);
Talk("韋兄弟..你現在位高權重，有花不完的銀子。當然覺得一切都無所謂。你有沒有想過萬一有一天康熙他和你翻臉時........那么你所擁有的這一切....", 196, 0);
Talk("對了那《四十二章經》是否都在你身上。", 85, 0);
Talk("恩里面的碎羊皮我都拼好了，師父讓我交給你。", 238, 0);
Talk("放心吧 韋兄弟我只是要尋找那天書。至于寶藏嘛，到時都給你留著。", 85, 0);
Talk("好兄弟 說話算話哦", 0, 1);
Talk("場景開啟神龍教（141，112）", 85, 0);