if InTeam(7) == true then goto label0 end;
    if InTeam(4) == true then goto label1 end;
        if InTeam(13) == true then goto label2 end;
...
::label4::
                    if HaveItemBool(95) == false then goto label5 end;
...
::label5::
                        ...
                        if CheckRoleSexual(256) == true then goto label6 end;
                            ...
                            if CheckRoleSexual(256) == true then goto label7 end;
                                ...
                                if InTeam(2) == false then goto label8 end;
