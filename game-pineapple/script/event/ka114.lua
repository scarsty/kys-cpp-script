...
instruct_50e(1, 0, 0, 100, 3, 11, 0);
instruct_50e(1, 0, 0, 100, 4, 78, 0);
instruct_50e(1, 0, 0, 100, 5, 81, 0);
instruct_50e(43, 4, 188, 75, 4, 0, 0);
::label302::
...
if CheckRoleSexual(256) then goto label394 end;
...
if CheckRoleSexual(256) then goto label522 end;
instruct_50e(3, 2, 0, 9, 9, 1, 0);
instruct_50e(4, 0, 0, 9, 10, 0, 0);
if CheckRoleSexual(256) then goto label542 end;
::label598::
...
if CheckRoleSexual(256) then goto label586 end;
instruct_50e(4, 10, 3, 13, 0, 0, 0);
if CheckRoleSexual(256) then goto label598 end;
