...
if CheckRoleSexual(256) == false then goto label298 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label298::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label318 end;
...
if CheckRoleSexual(256) == false then goto label358 end;
...
instruct_50e(43, 0, 185, 100, 216, 0, 0);
