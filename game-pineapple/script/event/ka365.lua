...
if CheckRoleSexual(256) == false then goto label251 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label251::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label271 end;
instruct_50e(3, 0, 0, 9, 2, 1, 0);
::label271::
instruct_50e(4, 0, 2, 8, 2, 0, 0);
if CheckRoleSexual(256) == false then goto label291 end;
