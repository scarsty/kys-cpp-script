...
if InTeam(4) == false then goto label48 end;
instruct_50e(3, 0, 2, 3, 3, 3, 0);
instruct_50e(3, 0, 3, 3, 3, 2, 0);
::label48::
if HaveItemBool(93) == false then goto label68 end;
...
if InTeam(8) == false then goto label152 end;
...
if CheckRoleSexual(256) then goto label192 end;
