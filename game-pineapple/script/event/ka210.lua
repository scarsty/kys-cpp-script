...
if InTeam(6) == false then goto label88 end;
instruct_50e(3, 0, 3, 2, 2, 5, 0);
instruct_50e(3, 0, 2, 2, 2, 2, 0);
::label88::
if HaveItemBool(95) == false then goto label108 end;
...
if CheckRoleSexual(256) then goto label212 end;
instruct_50e(3, 0, 3, 21, 20, 5, 0);
if InTeam(2) == false then goto label224 end;
...
if CheckRoleSexual(256) then goto label288 end;
...
if TryBattle(0) then goto label389 end;
...
instruct_50e(5, 0, 0, 0, 0, 0, 0);
instruct_50e(43, 0, 185, 80, 210, 0, 0);
::label128::