...
if CheckRoleSexual(256) == false then goto label312 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label312::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label332 end;
instruct_50e(3, 0, 0, 9, 2, 1, 0);
::label332::
instruct_50e(4, 0, 2, 8, 2, 0, 0);
if CheckRoleSexual(256) == false then goto label352 end;
instruct_50e(3, 0, 0, 10, 3, 1, 0);
::label352::
instruct_50e(4, 0, 2, 8, 3, 0, 0);
if CheckRoleSexual(256) == false then goto label372 end;
...
instruct_50e(43, 0, 185, 100, 204, 0, 0);
