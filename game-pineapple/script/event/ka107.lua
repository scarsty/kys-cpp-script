...
exit();
::label84::
instruct_50e(1, 0, 0, 100, 0, 5, 0);
instruct_50e(1, 0, 0, 100, 1, 10, 0);
instruct_50e(1, 0, 0, 100, 2, 11, 0);
instruct_50e(1, 0, 0, 100, 3, 46, 0);
instruct_50e(1, 0, 0, 100, 4, 47, 0);
instruct_50e(43, 4, 188, 65, 4, 0, 0);
::label294::
...
if CheckRoleSexual(256) then goto label386 end;
...
if CheckRoleSexual(256) then goto label462 end;
...
if CheckRoleSexual(256) then goto label514 end;
instruct_50e(3, 2, 0, 9, 9, 1, 0);
instruct_50e(4, 0, 0, 9, 10, 0, 0);
if CheckRoleSexual(256) then goto label534 end;
::label590::
...
if CheckRoleSexual(256) then goto label578 end;
instruct_50e(4, 10, 3, 13, 0, 0, 0);
if CheckRoleSexual(256) then goto label590 end;
...
if CheckRoleSexual(256) then goto label722 end;
