...
if CheckRoleSexual(256) == false then goto label266 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label266::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label286 end;
instruct_50e(3, 0, 0, 9, 2, 1, 0);
::label286::
instruct_50e(4, 0, 2, 8, 2, 0, 0);
if CheckRoleSexual(256) == false then goto label306 end;
instruct_50e(3, 0, 0, 10, 3, 1, 0);
::label306::
instruct_50e(4, 0, 2, 8, 3, 0, 0);
if CheckRoleSexual(256) == false then goto label326 end;
