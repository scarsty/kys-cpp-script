...
exit();
::label84::
instruct_50e(1, 0, 0, 100, 0, 10, 0);
instruct_50e(1, 0, 0, 100, 1, 53, 0);
instruct_50e(1, 0, 0, 100, 2, 77, 0);
instruct_50e(1, 0, 0, 100, 3, 80, 0);
instruct_50e(43, 4, 188, 74, 4, 0, 0);
::label286::
...
if CheckRoleSexual(256) then goto label286 end;
...
if CheckRoleSexual(256) then goto label378 end;
...
if CheckRoleSexual(256) then goto label454 end;
...
if CheckRoleSexual(256) then goto label526 end;
::label582::
...
if CheckRoleSexual(256) then goto label570 end;
...
if CheckRoleSexual(256) then goto label762 end;
