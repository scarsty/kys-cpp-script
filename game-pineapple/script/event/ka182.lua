instruct_50e(3, 0, 0, 4, 28928, 0, 0);
instruct_50e(3, 0, 0, 6, 28929, 0, 0);
...
if CheckRoleSexual(256) then goto label56 end;
instruct_50e(3, 2, 0, 9, 9, 1, 0);
instruct_50e(4, 0, 0, 9, 10, 0, 0);
if CheckRoleSexual(256) then goto label76 end;
if CheckRoleSexual(256) == false then goto label80 end;
::label136::
