...
Talk("這里有塊石碑，不知道干嗎的", 229, 0);
Talk("給點面子行不行，怎么說當年我也是白馬將軍，雖說現在買斷下崗……", 100, 0);
Talk("你自己也會說是當年了，現在你也不是國家干部了。我們袁大老爺說了，只要抓你回去，賞半只北京烤鴨", 229, 0);
...
if InTeam(2) == false then goto label0 end;
    ...
    Talk("死都死了還這么多廢話", 229, 0);
    instruct_50e(32, 0, 0, 2, 0, 0, 0);
    Talk("那不是趙大師父嗎？還不快來幫忙", 0, 0);
    Talk("趙大師父？！你原來是干廚子的？", 2, 0);
...
::label4::
                        ...
                        instruct_50e(19, 0, 0, 0, 0, 0, 0);
                        instruct_50e(3, 0, 1, 0, 0, 420, 0);
                        Talk("都這時候了，還扯這些陳年往事干什么！救人要緊", 229, 0);
                        instruct_50e(32, 0, 0, 2, 0, 0, 0);
                        Talk("終于得救了，這就是我訓練出的人才，趙大師父武藝已經如此高強了", 0, 0);
                        Talk("你給我等會兒，趙將軍什么時候成了趙大師父了", 229, 0);
                        Talk("你還不知道嗎？趙大師父當年是我北平烤鴨店的廚子，手藝……", 2, 0);
                        Talk("時間緊迫，還是不要說廢話了，末將當年的確曾在公孫將軍帳前效力。所謂有恩不報枉為人，末將這就保護公孫將軍前往長安，那里應該安全", 229, 0);
                        Talk("閑聊片刻沒什么，這位少俠也不是外人。看趙大師父，不對，是趙將軍槍法出神入化，槍槍鎖喉，很是眼熟，好像是當年烤鴨子的時候，用長棍挑鴨脖子的模樣…………", 2, 0);
                        instruct_50e(32, 0, 0, 2, 0, 0, 0);
                        Talk("公孫將軍好眼力，當年正式武學修行遇到瓶頸，所以下廚房尋求突破，終于在烤鴨上面找到靈感，槍法可以大成。（終于找到了一個體面的理由）", 0, 0);
                        Talk("武學博大精深，不只琴棋書畫，甚至洗衣做飯，喂馬割草也蘊藏武學精義（又多曝了糗事，還是就此打住吧）", 2, 0);
                        Talk("武學博大精深，不只琴棋書畫，甚至洗衣做飯，喂馬割草也蘊藏武學精義（又多曝了糗事，還是就此打住吧）有關武學一事，稍侯再和公子切磋，當務之急是送公孫瓚將軍去長安", 229, 0);
                        DarkScene();
                        ModifyEvent(-2, 13, -2, -2, -2, -2, -2, 0, 0, 0, 0, -2, -2);
                        LightScene();
exit();
::label0::
                        instruct_50e(32, 0, 0, 2, 0, 0, 0);
                        Talk("什么袁大老爺，混蛋袁紹！霸占了我的烤鴨店，居然還用烤鴨買兇殺人，我死不瞑目………………", 0, 0);
                        ModifyEvent(-2, 13, -2, -2, -2, -2, -2, 9444, 9444, 9444, 0, -2, -2);
                        Talk("前面可是前任北平太守兼烤鴨店CEO公孫將軍", 229, 0);
                        instruct_50e(32, 0, 0, 2, 0, 0, 0);
                        Talk("正是小弟，少俠快救我，袁紹想殺人滅口！", 0, 0);
                        instruct_50e(5, 0, 0, 0, 0, 0, 0);
                        ...
                        instruct_50e(43, 0, 198, 0, 0, 0, 0);
                        instruct_50e(32, 0, 3, 1, 0, 0, 0);
                        if TryBattle(0) == true then goto label6 end;
                            instruct_50e(43, 0, 199, 1, 0, 0, 0);
                            LightScene();
                            Talk("走的真快，真的非常快，但為什么剛才不跑呢", 229, 0);
                            DarkScene();
...
::label6::
                            ...
                            instruct_50e(19, 0, 0, 0, 0, 0, 0);
                            instruct_50e(3, 0, 1, 0, 0, 420, 0);
                            Talk("又是袁紹，看我的吧", 229, 0);
                            DarkScene();
                            ModifyEvent(-2, 13, -2, -2, -2, -2, -2, 0, 0, 0, 0, -2, -2);
                            LightScene();
                            instruct_50e(32, 0, 0, 2, 0, 0, 0);
                            Talk("這里還有點錢，多謝少俠救命之恩。告辭", 0, 0);
                            instruct_50e(32, 0, 0, 2, 0, 0, 0);
