...
::label9::
                                        ...
                                        if CheckRoleSexual(256) == false then goto label10 end;
                                            instruct_50e(0, 1, 6, 0, 0, 0, 0);
::label10::
                                            instruct_50e(4, 0, 2, 0, 5, 0, 0);
                                            if CheckRoleSexual(256) == false then goto label11 end;
                                                instruct_50e(0, 1, 3, 0, 0, 0, 0);
::label11::
                                                instruct_50e(4, 0, 2, 0, 6, 0, 0);
                                                if CheckRoleSexual(256) == false then goto label12 end;
                                                    instruct_50e(0, 1, 5, 0, 0, 0, 0);
::label12::
                                                    instruct_50e(21, 8, 83, 180, 2, 0, 0);
                                                    instruct_50e(21, 8, 83, 180, 3, 1, 0);
exit();
