...
LightScene();
if InTeam(6) == false then goto label339 end;
...
if CheckRoleSexual(256) then goto label403 end;
instruct_50e(22, 2, 26, 0, 5, 1, 0);
instruct_50e(4, 0, 2, 1, 0, 0, 0);
if CheckRoleSexual(256) then goto label403 end;
instruct_50e(4, 0, 0, 0, 4, 0, 0);
if CheckRoleSexual(256) == false then goto label435 end;
instruct_50e(3, 0, 0, 5, 0, 4, 0);
::label435::
instruct_50e(4, 0, 4, 0, 4, 0, 0);
if CheckRoleSexual(256) == false then goto label455 end;
...
::label586::
instruct_50e(4, 0, 4, 0, 4, 0, 0);
if CheckRoleSexual(256) == false then goto label606 end;
instruct_50e(3, 0, 1, 5, 0, 4, 0);
::label606::
instruct_50e(32, 0, 5, 2, 0, 0, 0);
