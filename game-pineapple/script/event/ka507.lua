...
if CheckRoleSexual(256) == false then goto label88 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label88::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label108 end;
instruct_50e(3, 0, 0, 9, 2, 1, 0);
::label108::
instruct_50e(4, 0, 2, 8, 2, 0, 0);
if CheckRoleSexual(256) == false then goto label128 end;
...
ModifyEvent(-2, -2, -2, -2, -2, -2, 508, -2, -2, -2, 0, -2, -2);