...
if CheckRoleSexual(256) == false then goto label290 end;
instruct_50e(3, 0, 1, 10, 3, 1, 0);
::label290::
instruct_50e(4, 0, 2, 8, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label310 end;
...
instruct_50e(43, 0, 185, 100, 215, 0, 0);
