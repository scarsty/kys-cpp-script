...
if CheckRoleSexual(256) == false then goto label123 end;
instruct_50e(32, 0, 28928, 1, 0, 0, 0);
AddItemWithoutHint(0, 1);
instruct_50e(3, 0, 1, 10041, 10041, 1, 0);
instruct_50e(4, 0, 4, 10041, 0, 0, 0);
if CheckRoleSexual(256) then goto label154 end;
::label123::
instruct_50e(4, 0, 5, 10042, 0, 0, 0);
if CheckRoleSexual(256) == false then goto label166 end;
instruct_50e(32, 0, 28928, 1, 0, 0, 0);
...
if CheckRoleSexual(256) == false then goto label209 end;
instruct_50e(32, 0, 28928, 1, 0, 0, 0);
AddItemWithoutHint(0, 100);
instruct_50e(3, 0, 1, 10043, 10043, 1, 0);
instruct_50e(4, 0, 4, 10043, 0, 0, 0);
if CheckRoleSexual(256) then goto label166 end;
::label209::
...
if CheckRoleSexual(256) then goto label209 end;
::label252::
instruct_50e(4, 0, 5, 10045, 0, 0, 0);
if CheckRoleSexual(256) == false then goto label295 end;
instruct_50e(32, 0, 28928, 1, 0, 0, 0);
AddItemWithoutHint(0, 10000);
instruct_50e(3, 0, 1, 10045, 10045, 1, 0);
instruct_50e(4, 0, 4, 10045, 0, 0, 0);
if CheckRoleSexual(256) then goto label252 end;
::label295::
instruct_50e(32, 0, 28928, 1, 0, 0, 0);
AddItemWithoutHint(0, -1);