...
exit();
::label0::
if InTeam(76) == false then goto label38 end;
Talk("王姑娘你好啊，不知王姑娘跟這位大哥要去哪里，可否帶在下一個．", 53, 0);
if AskJoin () then goto label48 end;
Talk("段公子，我也很想帶你一起可是怕王爺不讓，我看還是以后吧．", 0, 1);
exit();
::label48::
if TeamIsFull() == false then goto label59 end;
Talk("我的隊伍滿了，等我騰出一個空位來再說吧．", 0, 1);
exit();
::label59::
if CheckSubMapPic(16, 0, 5342) == false then goto label70 end;
