...
CheckSubMapPic(60, 2, 8560, 0, 1058);
    ...
    if AskRest() == true then goto  label1 end;
        ...
        Talk("好，那我就去會會他！", 55, 0);
        if TryBattle(125) == true then goto label2 end;
            Dead();
            exit();
::label2::
            LightScene();
            ...
            if TryBattle(126) == true then goto label3 end;
                Dead();
                exit();
::label3::
                LightScene();
                ...
                Talk("過兒，是他打的你嗎？", 59, 0);
                if TryBattle(127) == false then goto label4 end;
::label4::
                    LightScene();
...
::label1::
                        ...
                        if TryBattle(28) == true then goto label6 end;
                            Dead();
                            exit();
::label6::
                            ...
                            if TryBattle(29) == true then goto label7 end;
                                Dead();
                                exit();
::label7::
                                LightScene();
