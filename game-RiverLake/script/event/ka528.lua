...
x[10] = GetRole(106, 34 / 2);
x[10] = x[10] + 550;
SetRole(106, 34 / 2, x[10]);
x[10] = GetRole(106, 36 / 2);
x[10] = x[10] + 550;
SetRole(106, 36 / 2, x[10]);
x[10] = GetRole(106, 82 / 2);
x[10] = x[10] + 450;
SetRole(106, 82 / 2, x[10]);
x[10] = GetRole(106, 84 / 2);
x[10] = x[10] + 450;
SetRole(106, 84 / 2, x[10]);
x[10] = GetRole(106, 86 / 2);
x[10] = x[10] + 200;
SetRole(106, 86 / 2, x[10]);
x[10] = GetRole(106, 88 / 2);
x[10] = x[10] + 20;
SetRole(106, 88 / 2, x[10]);
x[10] = GetRole(106, 90 / 2);
x[10] = x[10] + 200;
SetRole(106, 90 / 2, x[10]);
x[10] = GetRole(106, 110 / 2);
x[10] = x[10] + 60;
SetRole(106, 110 / 2, x[10]);
LightScene();
