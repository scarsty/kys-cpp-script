...
until x[1000] >= 4;
x[400] = "前面的地名為目的地，后面的銀兩為要護送的銀兩數，事成賺取提成傭金．";        --instruct_50e(8, 0, 7222, 400, 0, 0, 0);
DrawRect(15, 45, 285, 50);        --instruct_50e(34, 0, 15, 45, 285, 50, 0);
DrawString(x[400], 20, 50, 26211);        --instruct_50e(33, 0, 400, 20, 50, 26211, 0);
x[1002] = 0;        --instruct_50e(0, 1002, 0, 0, 0, 0, 0);
x[1005] = 0;        --instruct_50e(0, 1005, 0, 0, 0, 0, 0);
x[40] = GetRole(0, 112 / 2);        --instruct_50e(17, 0, 0, 0, 112, 40, 0);
x[39] = 120;        --instruct_50e(0, 39, 120, 0, 0, 0, 0);
x[40] = x[39] - x[40];        --instruct_50e(3, 1, 1, 40, 39, 40, 0);
x[300] = math.random(x[40]);        --instruct_50e(38, 1, 40, 300, 0, 0, 0);
x[70] = GetRole(0, 6 / 2);        --instruct_50e(17, 0, 0, 0, 6, 70, 0);
print("x[300] = " .. x[300]);
print("x[70] = " .. x[70]);
if x[300] < x[70] then
x[1] = 7215;        --instruct_50e(0, 1, 7215, 0, 0, 0, 0);
repeat
...
until x[1002] >= 4;
DrawRect(95, 95, 150, 83);        --instruct_50e(34, 0, 95, 95, 150, 83, 0);
strs = {};
for i=1, 4 do
strs[i] = x[x[1100 + i - 1]];
end
x[100] = menu(100, 100, strs, #strs);        --instruct_50e(39, 0, 4, 1100, 100, 100, 100);
if x[100] == 1 then
AddItem(174, 1000);
Talk("祝你一路順風！", 78, 0);
...
if x[100] == 4 then
SetRole(0, 6 / 2, 0);        --instruct_50e(16, 0, 0, 0, 6, 0, 0);
Talk("護送一個人．．．？？", 0, 1);
...
x[1] = 7214;        --instruct_50e(0, 1, 7214, 0, 0, 0, 0);
repeat
x[1005] = x[1002] * 100;        --instruct_50e(3, 0, 2, 1005, 1002, 100, 0);
x[1005] = x[1005] + 2000;        --instruct_50e(3, 0, 0, 1005, 1005, 2000, 0);
x[x[1005]] = GetTalk(x[1]);        --instruct_50e(8, 1, 1, 400, 0, 0, 0);
