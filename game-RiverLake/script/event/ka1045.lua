...
if CheckRoleSexual(256) then goto label68 end;
...
if CheckRoleSexual(256) then goto label228 end;
instruct_50e(34, 0, 95, 95, 150, 83, 0);
instruct_50e(39, 0, 4, 1100, 100, 100, 100);
instruct_50e(4, 0, 2, 100, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label256 end;
AddItem(174, 1000);
Talk("祝你一路順風！", 78, 0);
...
if CheckRoleSexual(256) == false then goto label308 end;
AddItem(174, 3000);
Talk("祝你一路順風！", 78, 0);
...
if CheckRoleSexual(256) == false then goto label360 end;
AddItem(174, 5000);
Talk("祝你一路順風！", 78, 0);
...
instruct_50e(3, 0, 0, 1002, 1002, 1, 0);
instruct_50e(4, 0, 0, 1002, 4, 0, 0);
if CheckRoleSexual(256) then goto label577 end;
instruct_50e(34, 0, 95, 95, 150, 83, 0);
instruct_50e(39, 0, 4, 1100, 100, 100, 100);
instruct_50e(4, 0, 2, 100, 1, 0, 0);
if CheckRoleSexual(256) == false then goto label605 end;
AddItem(174, 500);
Talk("祝你一路順風！", 78, 0);
...
::label657::
instruct_50e(4, 0, 2, 100, 3, 0, 0);
if CheckRoleSexual(256) == false then goto label709 end;
AddItem(174, 3000);
Talk("祝你一路順風！", 78, 0);
ModifyEvent(3, 30, 0, -2, 0, 0, 556, 0, 0, 0, 0, -2, -2);
ModifyEvent(-2, -2, -2, -2, 553, 0, 0, -2, -2, -2, 0, -2, -2);
...
::label709::
instruct_50e(4, 0, 2, 100, 4, 0, 0);
if CheckRoleSexual(256) == false then goto label761 end;
AddItem(174, 5000);
Talk("祝你一路順風！", 78, 0);
ModifyEvent(9, 5, 0, -2, 0, 0, 557, 0, 0, 0, 0, -2, -2);
ModifyEvent(-2, -2, -2, -2, 553, 0, 0, -2, -2, -2, 0, -2, -2);
