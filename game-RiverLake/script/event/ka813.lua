...
if TryBattle(147) == true then goto label0 end;
    Dead();
    exit();
::label0::
    ...
    LightScene();
    Talk("靖哥哥，我來幫你．", 56, 4);
    if TryBattle(148) == true then goto label1 end;
        Dead();
        exit();
::label1::
        LightScene();
        Talk("爹，媽！", 149, 0);
        if TryBattle(149) == true then goto label2 end;
            Dead();
            exit();
::label2::
            LightScene();
            ...
            LightScene();
            Talk("留下九陰真經再走！", 124, 4);
            if TryBattle(150) == true then goto label3 end;
                Dead();
                exit();
::label3::
