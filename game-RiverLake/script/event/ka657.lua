...
if CheckRoleMorality(0, 31, 100) == false then goto label0 end;
...
if TryBattle(96) == false then goto label61 end;
LightScene();
Talk("張全祥：讓我來會會你！", 93, 0);
if TryBattle(97) == false then goto label61 end;
LightScene();
Talk("黎生：讓我來會會你！", 93, 0);
if TryBattle(98) == false then goto label61 end;
LightScene();
Talk("余洪興：讓我來會會你！", 93, 0);
if TryBattle(99) == false then goto label61 end;
LightScene();
Talk("彭有敬：讓我來會會你！", 93, 0);
if TryBattle(100) == false then goto label61 end;
LightScene();
Talk("魯有腳：讓我來會會你！", 93, 0);
if TryBattle(101) == false then goto label61 end;
LightScene();
...
if TryBattle(102) == false then goto label61 end;
LightScene();
Talk("這下你們服了吧？", 0, 0);
Talk("屬下參見莊幫主！", 108, 0);
Talk("屬下參見莊幫主！", 93, 1);
