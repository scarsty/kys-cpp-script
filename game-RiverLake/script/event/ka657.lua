if InTeam(48) then
if HaveItemBool(60) then
if CheckRoleMorality(0, 31, 100) then
...
if TryBattle(96) then
LightScene();
Talk("張全祥：讓我來會會你！", 93, 0);
if TryBattle(97) then
LightScene();
Talk("黎生：讓我來會會你！", 93, 0);
if TryBattle(98) then
LightScene();
Talk("余洪興：讓我來會會你！", 93, 0);
if TryBattle(99) then
LightScene();
Talk("彭有敬：讓我來會會你！", 93, 0);
if TryBattle(100) then
LightScene();
Talk("魯有腳：讓我來會會你！", 93, 0);
if TryBattle(101) then
LightScene();
