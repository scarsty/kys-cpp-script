SubMapViewFromTo(30, 28, 30, 14);
Talk("還請費兄回去告訴左掌門，五嶽併派之事，我衡山派是不會答應的．", 20, 0, 652);
Talk("莫掌門還請三思，五嶽合併之後，對我五嶽劍派是大有好處的．到時我五嶽派就可和少林，武當各大派相庭抗禮了．", 84, 4, 653);
Talk("衡山派百年基業，還不想斷送在我莫大手裡．費兄還請回吧！", 20, 0, 654);
Talk("本來我是不想提的，劉師兄此次金盆洗手，是跟魔教有關吧？左盟主已知道其中曲折了，但顧全五嶽同盟之情．．．所以還是請莫掌門三思，屆時還望光臨嵩山，參加五獄同盟大會．", 84, 4, 655);
Talk("送客！", 20, 0, 656);
DarkScene();
