...
Talk("＜如此好武又天真的人，  他該不會就是周伯通＞前輩是周伯通周前輩吧．", 0, 1);
Talk("是啊，我就是周伯通啊，不過大家都叫我老頑童．", 64, 0);
Talk("前輩，我帶你去見一個人．", 0, 1);
Talk("去見誰啊？", 64, 0);
Talk("我說出此人的名字來，你可不許拂袖便走．", 0, 1);
Talk("世間我有兩個人不見．一位是段皇爺，一位是他的貴妃瑛姑．除了這二人之外，我老頑童誰都見得．", 64, 0);
Talk("＜看來只有使個激將之計＞原來你曾輸在他們手裡，武功不及，因此害怕見他們．", 0, 1);
...
Talk("你和瑛姑生的孩子啊！", 0, 1);
Talk("什麼！我有兒子！．．．．．", 64, 0);
Talk("周老前輩，瑛姑如此這般思念你，你始終不肯和他相見，於心何忍？", 0, 1);
Talk("她在那裡？", 64, 0);
Talk("他現正居住在黑龍潭，在鐵掌山的南邊．", 0, 1);
DarkScene();
ModifyEvent(-2, -2, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
LightScene();
Talk("咦，老頑童呢？怎麼一溜煙的就不見了，希望是去找瑛姑了．", 0, 1);
