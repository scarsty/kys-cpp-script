Talk("前輩好福氣，竟住在如此奇妙的所在．", 0, 1);
Talk("你倒說說看，我這百花谷怎生好法．", 64, 0);
Talk("此處山谷向南，高山阻住了北風，想來地下又有硫磺，煤炭等類礦藏，地氣特暖．因之陽春早臨，百花先放．", 0, 1);
Talk("小兄弟還算有點見識．不過下次你再來時，又會有另一番風貌的．最近我正在馴養蜜蜂，雖然有點．．有點不順，但．．但我一定會想辦法讓這些小東西乖乖馴服的．", 64, 0);
Talk("這陣子晚輩遍遊江湖各地，道聽途說了一些，沒什麼收穫，倒是見聞增廣了不少．", 0, 1);
Talk("你說你最近跑遍江湖，那你知不知道武林中有什麼新功夫問世．", 64, 0);
Talk("晚輩是得到一些秘笈，不過功夫還不到家．", 0, 1);
