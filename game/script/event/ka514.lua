...
Talk("方丈這是做什麼，今天我去揭發喬峰，是為武林除害．", 51, 1);
Talk("是嗎？依老衲看，是為了你大燕復國的計畫吧．其實我早就該想到了，當初就是你父親慕容博施主，假傳音訊，說是契丹武士要大舉侵犯少林奪取武學典籍，才會釀成大錯．這一切，都是你父親要挑起漢遼武人相鬥，使你大燕從中取利．", 70, 0);
Talk("．．．．．", 51, 1);
Talk("快將信件留下．", 70, 0);
Talk("方丈不怕我將你的事也揭露出來．", 51, 1);
Talk("我個人事小，中原武林的和諧才重要，我不能讓你利用此信，引起武林的大風暴．", 70, 0);
Talk("好，你別怪我．這事傳出去後，看你少林寺的臉往那裡擺．一個堂堂的少林方丈和女人亂來，還生下了一名私生子．．．．．", 51, 1);
Talk("有這等事？", 0, 1);
