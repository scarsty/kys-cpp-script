...
LightScene();
Talk("我看福威鑣局的武功也稀鬆平常，鑣還是不要給你們保比較妥當．", 0, 1);
...
Talk("少俠武功高強，請少俠幫我救出家父，我林平之這輩子願做牛做馬服侍你．若少俠願意幫忙，我福威鏢局中的任何物品，少俠都可隨意取用．這其中還包括了一本”松風劍譜”，是我從青城派那幾個小賊身上偷來的．想研究看看他們的劍招上是不是有什麼破綻．", 36, 0);
