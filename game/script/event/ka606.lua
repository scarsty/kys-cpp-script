...
Talk("哈！言兄，你崑崙派自許為名門正派，想不到也覬覦這”連城訣”啊．", 94, 0);
Talk("哼！天下人之物，天下人得之．在場的崆峒，青城，泰山，還有這些其他各大門派的高手，不也是這麼想嗎？", 78, 0);
SubMapViewFromTo(20, 39, 20, 47);
Talk("嘩！這裡可真熱鬧，想必各位都是為那”連城訣”而來的吧．但是很對不起，這東西我先定下，沒你們的份了．", 0, 1);
Talk("小子，找死！", 97, 0);
