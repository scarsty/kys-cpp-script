Talk("看你的樣子，妳大概就是金花婆婆吧．快放了王前輩，否則要你吃不完兜著走．", 0, 1);
Talk("胡青牛老眼昏花了是不是，叫了個小子來送死．小子，我看你年紀輕輕的，快走吧，別自討苦吃了．", 15, 0);
Talk("你活生生的拆散人家夫妻，我就是看不慣，這檔事我管定了．", 0, 1);
Talk("本來想這不關你的事，你非要管，我就讓你這不知天高地厚的小子吃點苦頭．", 15, 0);
