...
Talk("＜搞不好俠客島上有線索？  不是有本書與”俠”字有  關聯嗎？＞", 0, 1);
WalkFromTo(29, 24, 29, 19);
Talk("銅牌給我好不好？", 0, 1);
Talk("恐怕不行，俠客島所邀請的是各門派的掌門及對武學有特殊見解的武林高手．", 41, 0);
Talk("那如果我打敗他，是不是表示我比他有資格去．", 0, 1);
Talk("那裡來的小娃兒，敢在我凌霄城撒野．", 43, 0);
