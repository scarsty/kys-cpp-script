...
Talk("幹嘛？小心得”愛滋”．", 0, 1);
Talk("黃鐘公，我令你們在杭州好好看守著任我行，原來你們都在給我玩什麼”麻將”．", 27, 0);
Talk("小的該死！唉！玩物喪志．都因屬下四人沈溺於琴棋書畫，給人窺到這老大弱點，定下奸計將那人劫了出去．", 34, 0);
...
LightScene();
Talk("老頭子，是你．那天你怎麼不敢跟我比劃，還暗算我．", 0, 1);
Talk("小兄弟，多虧你了．要不是你誤打誤撞，我任我行此刻還在地牢內呢．", 26, 0);
if TeamIsFull() then
Talk("今天你是來搶”笑傲江湖”一書的吧．我來此本是想幫你一把的，但看你人手似乎已然足夠，我就在一旁看你們表演吧．", 26, 0);
end;
if TeamIsFull() == false then
Talk("今天你是來搶”笑傲江湖”一書的吧．我就幫你一把，算是一點謝意．", 26, 0);
end;
Talk("你究竟是誰？", 0, 1);
Talk("我是誰，你問這個娘娘腔的傢伙好了．東方不敗，恭喜你練成了”葵花寶典”上的武功．", 26, 0);
Talk("任教主，這部”葵花寶典”是你傳給我的．我一直念著你的好處．", 27, 0);
Talk("＜原來他是日月神教的前任  教主？＞", 0, 1);
...
Talk("任教主，你待我的種種好處我永遠記得．你破格提拔，連年升我職，甚至連本教至寶的”葵花寶典”也傳給了我．此恩此德東方不敗永不敢忘．初時我一心只想做日月神教教主，想什麼千秋萬載，一統江湖，於是處心積慮的謀你的位，翦除你的羽翼．我初當教主，那可意氣風發了，說什麼文成武德，中興聖教，當真是不要臉的胡吹法螺．直到後來修習”葵花寶典”才慢慢悟到了人生妙諦．其後勤修內功，數年之後，終於明白了天人化生，萬物滋長的要道．如今，我最羨慕的就是那些青春年少的嬌媚女子，如果能易地而處，別說日月神教的教主，就算是皇帝老子，我也不做．", 27, 0);
Talk("你這男扮女裝的老旦，真令人噁心．", 0, 1);
Talk("大膽！", 27, 0);
if TeamIsFull() == false then
    Join(26);
...
Talk("東方不敗，今日終於．．．終於教你落在我手裡．", 26, 0);
Talk("任教主，終究是．．是．．終究是．．是我輸了．", 27, 0);
Talk("哈！哈！你這大號，可得改一改罷？", 26, 0);
Talk("倘若單打獨鬥，你們是不能打敗我的．", 27, 0);
Talk("不錯，你武功比我高，我很是佩服．", 26, 0);
Talk("閣下武功極高，不愧稱得”天下第一”四字，在下十分欽佩．", 0, 1);
Talk("你二位能這麼說，足見男子漢大丈夫氣概．唉，冤孽，冤孽，我練了那”葵花寶典”，照著寶典上的秘方，自宮練氣，煉丹服藥，漸漸的鬍子沒有了，說話聲音變了，性子也變了．我從此不愛女子，把七個小妾都殺了，卻．．．卻把全副心意放在蓮弟身上．倘若我生為女兒身，那就好了．任教主，你快把我殺了！", 27, 0);
...
Talk("胡說八道！什麼千秋萬載？哈！哈！哈！小兄弟，這一役誅奸復位，你實佔首功．這本”笑傲江湖”你就拿去吧．江湖上的人以為它是個高深的武功秘笈，其實只不過是本故事書罷了．", 26, 0);
Talk("要說到真正的武功秘笈，有什麼能比的上這本”葵花寶典”呢？可惜，這並不是常人可以練的．", 26, 0);
Talk("這話怎講？", 0, 1);
Talk("這寶典的第一頁就註明著，”欲練神功，引刀自宮”，老夫可不會沒了腦子，去幹這等傻事．哈哈，哈哈．．．．可是寶典上所載的武功實在厲害，任何學武之人，一見之後卻不能不動心．東方不敗，饒你奸詐似鬼，也猜不透老夫傳你”葵花寶典”的用意．你野心勃勃，意存拔扈，難道老夫瞧不出來嗎？哈哈，哈哈！", 26, 0);
