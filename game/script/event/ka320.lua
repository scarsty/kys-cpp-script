...
Talk("你就是東方不敗？＜怎麼看起來像個娘們？＞", 0, 1, 1075);
Talk("小子，梅莊的帳還沒跟你算，你還敢上黑木崖來．", 33, 0, 1076);
Talk("嗨！四位近來過的如何？”麻將”的技術有沒有更精進呢？", 0, 1, 1077);
Talk("啊！你便是到梅莊救走任我行的那小子．我早想見你一見，看看是怎樣的一位俊俏　郎君．哼，依我看也是平平無奇，比起我那蓮弟來，可差的遠了．", 27, 0, 1078);
Talk("幹嘛？小心得”愛滋”．", 0, 1, 1079);
Talk("黃鐘公，我令你們在杭州好好看守著任我行，原來你們都在給我玩什麼”麻將”．", 27, 0, 1080);
Talk("小的該死！唉！玩物喪志．都因屬下四人沈溺於琴棋書畫，給人窺到這老大弱點，定下奸計將那人劫了出去．", 34, 0, 1081);
Talk("教主文成武德，仁義英明，望教主再給我們四兄弟一個機會，將這小子拿下．", 33, 0, 1082);
Talk("什麼文成武德，仁義英明，東方不敗，你肉不肉麻啊！", 26, 0, 1083);
DarkScene();
ModifyEvent(-2, 55, 1, 1, -1, -1, -1, 6078, 6078, 6078, -2, -2, -2);
LightScene();
Talk("老頭子，是你．那天你怎麼不敢跟我比劃，還暗算我．", 0, 1, 1084);
Talk("小兄弟，多虧你了．要不是你誤打誤撞，我任我行此刻還在地牢內呢．", 26, 0, 1085);
if TeamIsFull() then
Talk("今天你是來搶”笑傲江湖”一書的吧．我來此本是想幫你一把的，但看你人手似乎已然足夠，我就在一旁看你們表演吧．", 26, 0, 1099);
end;
if TeamIsFull() == false then
Talk("今天你是來搶”笑傲江湖”一書的吧．我就幫你一把，算是一點謝意．", 26, 0, 1086);
end;
Talk("你究竟是誰？", 0, 1, 1087);
Talk("我是誰，你問這個娘娘腔的傢伙好了．東方不敗，恭喜你練成了”葵花寶典”上的武功．", 26, 0, 1088);
Talk("任教主，這部”葵花寶典”是你傳給我的．我一直念著你的好處．", 27, 0, 1089);
Talk("＜原來他是日月神教的前任  教主？＞", 0, 1, 1090);
Talk("是嗎？因此你將我關在西湖湖底，教我不見天日．", 26, 0, 1091);
Talk("我沒殺你，是不是？只須我叫江南四友不送水給你喝，你能捱的了十天半月嗎？", 27, 0, 1092);
Talk("這樣說來，你待我還算不錯了？", 26, 0, 1093);
Talk("正是．我讓你在杭州西湖頤養天年．常言道，上有天堂，下有蘇杭．西湖風景，那是天下有名的了，孤山梅莊，更是西湖景色絕佳之處．", 27, 0, 1094);
Talk("原來你讓我在西湖湖底的黑牢中頤養天年．那可要多謝你了．", 26, 0, 1095);
Talk("任教主，你待我的種種好處我永遠記得．你破格提拔，連年升我職，甚至連本教至寶的”葵花寶典”也傳給了我．此恩此德東方不敗永不敢忘．初時我一心只想做日月神教教主，想什麼千秋萬載，一統江湖，於是處心積慮的謀你的位，翦除你的羽翼．我初當教主，那可意氣風發了，說什麼文成武德，中興聖教，當真是不要臉的胡吹法螺．直到後來修習”葵花寶典”才慢慢悟到了人生妙諦．其後勤修內功，數年之後，終於明白了天人化生，萬物滋長的要道．如今，我最羨慕的就是那些青春年少的嬌媚女子，如果能易地而處，別說日月神教的教主，就算是皇帝老子，我也不做．", 27, 0, 1096);
Talk("你這男扮女裝的老旦，真令人噁心．", 0, 1, 1097);
Talk("大膽！", 27, 0, 1098);
if TeamIsFull() == false then
    Join(26);
...
Talk("東方不敗，今日終於．．．終於教你落在我手裡．", 26, 0, 1100);
Talk("任教主，終究是．．是．．終究是．．是我輸了．", 27, 0, 1101);
Talk("哈！哈！你這大號，可得改一改罷？", 26, 0, 1102);
Talk("倘若單打獨鬥，你們是不能打敗我的．", 27, 0, 1103);
Talk("不錯，你武功比我高，我很是佩服．", 26, 0, 1104);
Talk("閣下武功極高，不愧稱得”天下第一”四字，在下十分欽佩．", 0, 1, 1105);
Talk("你二位能這麼說，足見男子漢大丈夫氣概．唉，冤孽，冤孽，我練了那”葵花寶典”，照著寶典上的秘方，自宮練氣，煉丹服藥，漸漸的鬍子沒有了，說話聲音變了，性子也變了．我從此不愛女子，把七個小妾都殺了，卻．．．卻把全副心意放在蓮弟身上．倘若我生為女兒身，那就好了．任教主，你快把我殺了！", 27, 0, 1106);
Talk("我現在不想殺你了，我也找個地方安養你好了．來人啊，把他帶下去．", 26, 0, 1107);
Talk("你好狠毒！", 27, 0, 1108);
DarkScene();
ModifyEvent(-2, 86, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
LightScene();
Talk("恭喜教主，今日誅卻大逆．從此我教在教主庇蔭之下，揚威四海．教主千秋萬載，一統江湖．", 33, 0, 1109);
Talk("胡說八道！什麼千秋萬載？哈！哈！哈！小兄弟，這一役誅奸復位，你實佔首功．這本”笑傲江湖”你就拿去吧．江湖上的人以為它是個高深的武功秘笈，其實只不過是本故事書罷了．", 26, 0, 1110);
Talk("要說到真正的武功秘笈，有什麼能比的上這本”葵花寶典”呢？可惜，這並不是常人可以練的．", 26, 0, 1111);
Talk("這話怎講？", 0, 1, 1112);
Talk("這寶典的第一頁就註明著，”欲練神功，引刀自宮”，老夫可不會沒了腦子，去幹這等傻事．哈哈，哈哈．．．．可是寶典上所載的武功實在厲害，任何學武之人，一見之後卻不能不動心．東方不敗，饒你奸詐似鬼，也猜不透老夫傳你”葵花寶典”的用意．你野心勃勃，意存拔扈，難道老夫瞧不出來嗎？哈哈，哈哈！", 26, 0, 1113);
Talk("＜原來當初任教主以”葵花  寶典”傳他，當初便沒懷  善意．＞＜兩人爾虞我詐各懷心機＞”葵花寶典”一書，不知任教主能否借在下一看．", 0, 1, 1114);
