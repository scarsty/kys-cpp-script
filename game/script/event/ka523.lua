Talk("哇！這兒有那麼多乞丐，我身上的零錢可能不太夠．", 0, 1, 1896);
Talk("閣下別驚慌，我們群丐在這裡聚聚，不會向你乞討的．", 93, 0, 1897);
Talk("一大群乞丐聚在這裡，你們該不會是丐幫吧？", 0, 1, 1898);
Talk("正是．", 93, 0, 1899);
Talk("久聞丐幫乃天下第一大幫，人數之眾，為武林之最．小弟行走江湖，說什麼也得認識一下丐幫的英雄好漢．", 0, 1, 1900);
Talk("閣下好說．", 93, 0, 1901);
Talk("不知這位大哥是否可替我引見一下貴幫幫主．", 0, 1, 1902);
Talk("想見我們幫主，那也得是個英雄好漢才行．", 93, 0, 1903);
Talk("怎樣才算是個英雄好漢？", 0, 1, 1904);
Talk("你說呢．", 93, 0, 1905);
Talk("嗯．．．．．．．．．．．．．．．．．．．．久聞丐幫打狗陣威力無比，在下不才，想與各位切磋切磋．", 0, 1, 1906);
...
LightScene();
Talk("閣下這樣的功夫，似乎不配見我家幫主．", 93, 0, 1908);
exit();
end;
...
LightScene();
Talk("閣下功夫不錯，竟破了我丐幫之打狗陣法．喬幫主就在裡面，請進，我家幫主一定很高興認識你．", 93, 0, 1907);
AddFame(2);