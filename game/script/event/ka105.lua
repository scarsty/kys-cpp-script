...
Talk("要我回去做什麼，看他們在那裡爭吵誰要當教主嗎？老太婆我倒寧願留在這清靜清靜．", 15, 0);
Talk("龍王，妳還有所不知，陽教主生前留下一封遺書，要謝護法暫代副教主之位．事情的經過是這樣的．．．", 0, 1);
Talk("那更好了，有謝三哥在，教中的一切事務，我就放心了．而我，就更可以在這休養了．", 15, 0);
Talk("＜看來得激她一下 ＞我說明教這”光明聖火陣”有多厲害嘛？我倒也不信．明教被六大派圍攻，還不是靠我去幫他們解圍．我看是謝護法不想給我這”倚天屠龍記”一書，才故意編了這麼一個難題．", 0, 1);
Talk("你說什麼？你是說我明教都沒人了，一切都要靠你這娃兒幫忙？", 15, 0);
Talk("我是沒這麼說，但事實是如此．", 0, 1);
Talk("小娃兒，不要以為運氣好打贏了幾場，就神氣起來了．要知一山還有一山高，我明教這”光明聖火陣”從創教至今，還沒人能破過．", 15, 0);
Talk("我就不信有什麼是破不了的．", 0, 1);
Talk("好大的口氣，我就讓你知道”光明聖火陣”的厲害，有種就上我光明頂來．", 15, 0);
