Talk("兄台，你在幹什麼，”那兒”不會痛嗎？", 0, 1);
Talk("我在練門神功，痛也得忍．要知練完之後，我就是武林中”最強最猛”之人．", 29, 0);
Talk("原來如此？還有，你家怎麼有張這麼大的床？", 0, 1);
Talk("床大好辦事啊．", 29, 0);
Talk("辦事，辦什麼事？", 0, 1);
Talk("我田伯光會辦什麼事，當然是神仙做的事．有這麼大的床，才可以同時搞五，六個妞，真爽．過些時後，我要再去抓些俏妞，到時兄弟想不想一起來爽啊？", 29, 0);
