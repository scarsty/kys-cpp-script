...
DarkScene();
LightScene();
Talk("嗯．．．前去無路，後有追兵，正也不是，邪也不是，那可難也！．．．＜咦，棋局上的白子黑子似乎都化做了各派高手，東一堆使劍，西一堆使拳，你圍住我，我圍住你，互相糾纏不清的廝殺．．．．．．．我方白色的人馬被黑色各派高手給圍住了，左衝右突，始終殺不出重圍．．．．＞難道我天命已盡，一切枉費心機了．我這樣努力的找尋”十四天書”，終究要化作一場夢！時也命也，夫復何言？我不如死了算了．", 0, 1);
Talk("不可如此！＜大哥似乎入魔障了，怎麼辦？有了，我解不開這棋局，但搗亂一番，讓他心神一分，便有救了．．．．．．．＞我來解這棋局．嗯！就下在這裡好了．", 49, 1);
...
Talk("賢弟誤打誤撞，反而收其效果．", 0, 1);
Talk("神僧天賦英才，可喜可賀．請入屋內．", 52, 0);
Talk("這．．．．．", 49, 1);
Talk("賢弟就進去吧．搞不好老前輩要發獎品給你呢．", 0, 1);
DarkScene();
