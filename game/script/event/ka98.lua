Talk("老婆婆，這島很美，您一個人住著嗎？", 0, 1, 378);
Talk("小子，來我島上尋晦氣的嗎？", 15, 0, 379);
Talk("沒的事，我只是四處旅遊，無意間來到這島上的．", 0, 1, 380);
Talk("說實話，你是那一派的弟子？到這島上來做什麼？", 15, 0, 381);
Talk("我無門無派，無師自通，自己四處”練練功”罷了．", 0, 1, 382);
Talk("自已四處練練？那好，我老太婆就來陪你玩玩．", 15, 0, 383);
if AskBattle() == false then
ModifyEvent(-2, -2, -2, -2, 99, -1, -1, -2, -2, -2, -2, -2, -2);
exit();
end;
Talk("好啊！閒來無事，就跟您老人家練練功增加些經驗點數吧．", 0, 1, 384);
