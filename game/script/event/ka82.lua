Talk("哇！這裡這麼多人，幹什麼這麼熱鬧，可少不了小俠我．我說名門正派又怎麼樣，還不是一樣趕盡殺絕，跟魔教又有什麼兩樣，只不過藉口好聽一點罷了．", 0, 1, 296);
Talk("都是你這個兔崽子，打傷了鷹王和我，", 14, 0, 297);
Talk("還有我．", 11, 0, 298);
Talk("害我們只剩下范右使應戰，寡不敵眾．．．．．", 14, 0, 299);
Talk("既然如此，我就幫你們打發這些人，當是陪罪好了．", 0, 1, 300);
Talk("少俠非魔教人士，還請速速離去，以免受池魚之殃．", 70, 0, 301);
Talk("那好，大家都別打了，因為這中間著實有許多誤會，讓我好好說給你們聽．", 0, 1, 302);
Talk("現在年輕人都這麼狂妄嗎？你自以為是武林盟主嗎！要我們聽你說．", 6, 0, 303);
Talk("你這小賊，跟魔教勾結，想要拖延時間，好施什麼詭計麼？先殺了你再說．", 8, 0, 304);
Talk("我就知道要你們安安靜靜聽我說是不太可能，那只有想辦法讓你們服氣了．一起來吧，這樣比較省事．", 0, 1, 305);
Talk("好狂妄的口氣．", 6, 0, 306);
Talk("阿彌陀佛．", 70, 0, 307);
...
LightScene();
Talk("如何？現在肯安靜地聽我說了吧．事情的經過是這樣的．．．如此如此．．．．．．．．這般這般．．．．．．．．總之，一切的陰謀，都是成崑那奸賊所計劃的．所以我說呢，你們兩方還是握手言和吧，反正明教殺過六大派的人，六大派也殺過明教的人，大家半斤八兩，差不了多少，就都罷手吧．", 0, 1, 308);
Talk("話都是你在說的，是不是真的，我們怎麼知道．", 8, 0, 309);
Talk("哼！技不如人，說這麼多做什麼，走吧！", 6, 0, 310);
Talk("阿彌陀佛，盼少俠以後多所規勸引導，總要使明教改邪歸正，少做壞事．我們走吧．", 70, 0, 311);
DarkScene();
...
LightScene();
Talk("小子，你還不賴嘛！", 14, 0, 312);
Talk("蝠王，不可無禮．明教全教下上，叩謝少俠護教救命的大恩！", 10, 0, 313);
Talk("快別這麼說，仗義行俠，本就是我輩中人應當做的．況且，這次也因為我的魯莽，害你們陷入苦戰．", 0, 1, 314);
Talk("那裡，是我們沒問清楚．", 12, 0, 315);
Talk("你們也別這麼客套了．這樣吧，大家聽我一言，我說呢，這位少俠武功蓋世義薄雲天，於本教有存亡續絕的大恩．咱們擁立他為本教第三十四任教主．由他來做教主，總比你來做教主好吧，楊左使，你說對不對啊．", 14, 0, 316);
Talk("是啊！這位少俠來做我們教主，也比你韋一笑來做好的多．", 11, 0, 317);
Talk("你．．．．", 14, 0, 318);
Talk("你們兩個別在那裡吵了，丟人現眼的．", 10, 0, 319);
Talk("不，不，在下我雖然一直夢想能當個什麼掌門教主的．但是我仍有要事在身，且跟你們是不同世界的人，所以你們還是另覓他人吧．", 0, 1, 320);
Talk("少俠如果一直推卻不肯，我們明教恐怕又要為此爭鬧不休，四分五裂，到時又會被其他門派圍攻，導致滅亡了．", 10, 0, 321);
Talk("我這裡有封陽教主的遺書，上面提到要謝遜謝法王暫代教主之職．我想你們還是先找到他再說吧．", 0, 1, 322);
Talk("哦！真是如此，來人啊！即刻通令下去，全力尋找謝法王．", 10, 0, 323);
Talk("另外還有一件事拜託你們，你們明教中是否有一本叫”倚天屠龍記”的書？是否能借我一下．", 0, 1, 324);
Talk("有的．陽教主曾對我提過，我們教中有一本奇書，是我明教鎮教之寶，皆由歷代教主相傳而下．", 10, 0, 325);
Talk("是嗎？真的有．皇天不負苦心人，打了這麼多場仗，終於讓我找到了．", 0, 1, 326);
Talk("可是，這本書因為陽教主的突然消失，其下落也無人知道了．", 10, 0, 327);
Talk("少俠別擔心，等我們找到謝法王，整頓好教務後，必當全力搜尋此書的下落．若有消息，定當告之少俠．", 12, 0, 328);
Talk("好吧，也只有這樣了．我有空也會幫你們找找謝前輩，在下這就告辭了．", 0, 1, 329);
Talk("這裡有塊鐵燄令，是我明教的信物．少俠在江湖上行走，若有什麼困難需要我明教幫忙的時後，只須出示這塊鐵燄令，我明教全體教眾一定全力相助．", 10, 0, 330);
AddItem(190, 1);
AddMorality(10);
AddFame(15);