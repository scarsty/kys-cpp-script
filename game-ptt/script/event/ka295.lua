Talk("看你的樣子，你就是那”狗熊野豬”的頭頭？", 0, 1);
Talk("閣下是誰，為何跟我青城派過不去？", 24, 0);
Talk("我跟你說，快將林震南前輩放了，否則打你滿頭包．", 0, 1);
Talk("原來是為了林家的事．", 24, 0);
Talk("快說，林前輩在那？", 0, 1);
Talk("哼！只怕你見不到他了．", 24, 0);
Talk("你將他殺了？", 0, 1);
...
Talk("我看起來像會亂殺人的嗎？要如何處置你，由林家自己來決定．", 0, 1);
ModifyEvent(-2, -2, -2, -2, 290, -1, -1, -2, -2, -2, -2, -2, -2);
