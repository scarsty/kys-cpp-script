...
if a<=0 then
	...
	DarkScene();
	setscenemappro(4324*2,68,1,41,34);
	setscenemappro(3560*2,68,1,41,33);
	setscenemappro(1260*2,68,1,42,34);
	setscenemappro(1260*2,68,1,42,33);
	setscenemappro(1260*2,68,1,41,32);
	setscenemappro(2596*2,68,1,43,33);
	setscenemappro(3043*2,68,1,42,31);
	setscenemappro(3186*2,68,1,43,35);
	setscenemappro(3021*2,68,1,41,36);
	setsceneface(3);
	LightScene();
	...
	darkscene();
	setscenemappro(0,68,1,41,34);
	setscenemappro(0,68,1,41,33);
	setscenemappro(0,68,1,42,34);
	setscenemappro(0,68,1,42,33);
	setscenemappro(0,68,1,41,32);
	setscenemappro(0,68,1,43,33);
	setscenemappro(0,68,1,42,31);
	setscenemappro(0,68,1,43,35);
	setscenemappro(0,68,1,41,36);
	lightscene();
end
exit();
